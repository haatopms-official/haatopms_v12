...
const FALLBACK_SUPABASE_URL = 'https://nftthpqwicinmqtddypk.supabase.co';
const FALLBACK_SUPABASE_PUBLISHABLE_KEY = 'sb_publishable_fKpKizxmtJK1inMfzWI10g_PoMpiIhv';
